...
const ComparisonSection = () => {
  ...
  return (
    <section className="comparison" id="comparativo">
        ...
        <div className="comparison-grid">
          <div className="comparison-content">
            ...
            <div className="comparison-actions">
              <button
                className="comparison-action comparison-action--primary"
                type="button"
                onClick={() => {
              ...
              <button
                className="comparison-action comparison-action--ghost"
                type="button"
                onClick={() => {
            ...
            <div className="comparison-card">
              <div className="comparison-card-header">
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`comparison-tab ${activeScenario === scen.id ? 'active' : ''}`}
                      >
                        <Icon size={14} />
                ...
                <div className="comparison-toggle">
                  <button
                    type="button"
                    className={`comparison-toggle-label ${!isAfter ? 'active' : ''}`}
                  ...
                  <button
                    type="button"
                    className={`comparison-toggle-track ${isAfter ? 'active' : ''}`}
                    role="switch"
              ...
              <div className="comparison-card-body">
                <div className="comparison-kpis">
                  {currentData.kpis.map((kpi) => {
                    ...
                    return (
                      <div key={kpi.id} className="comparison-kpi">
